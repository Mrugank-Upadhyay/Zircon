...
<YYINITIAL> {
  ...
  {HTMLCloseTag}                 {   return token(TokenType.KEYWORD, TAG_CLOSE); }
  {OpenTagStart}                 {
                                     yybegin(TAG);
                                     return token(TokenType.KEYWORD, TAG_OPEN);
                                 }
  ...
  {CommentStart}                 {
                                     yybegin(COMMENT);
                                     return token(TokenType.COMMENT, COMMENT_OPEN);
                                 }
  {CDataStart}                   {
                                     yybegin(CDATA);
...
<TAG> {
  {HTMLAttribute}                { return token(TokenType.IDENTIFIER); }
  {Attribute}                    { return token(TokenType.IDENTIFIER); }
...
<COMMENT> {
  {CommentEnd}                   {
                                     yybegin(YYINITIAL);
                                     return token(TokenType.COMMENT, COMMENT_CLOSE);
                                 }
   ~{CommentEnd}                 {
                                     yypushback(3);
...
<CDATA> {
  {CDataEnd}                     {
                                     yybegin(YYINITIAL);
                                     return token(TokenType.COMMENT, CDATA_CLOSE);
                                 }
  ~{CDataEnd}                    {
                                     yypushback(3);
                                     return token(TokenType.COMMENT);
